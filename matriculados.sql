...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-06-2025 a las 02:47:35
...
CREATE TABLE `alumnoweb` (
  ...
  `apppaEstdWeb` varchar(50) NOT NULL,
  `apmaEstdWeb` varchar(50) NOT NULL,
  `nombEstdWeb` varchar(50) NOT NULL,
  `fechNaciEstdWeb` date NOT NULL,
  `logiEstdWeb` varchar(100) NOT NULL,
  `passEstdWeb` varchar(500) NOT NULL
...
INSERT INTO `alumnoweb` (`codiEstdWeb`, `ndniEstdWeb`, `apppaEstdWeb`, `apmaEstdWeb`, `nombEstdWeb`, `fechNaciEstdWeb`, `logiEstdWeb`, `passEstdWeb`) VALUES
(1, '12345', 'alor', 'alor', 'alor', '2025-06-18', 'alor', '$2a$10$RWSeopvH6ofQJUDNZwBfJO1Z8eD.gEXzIE3drUYMS4EQ1.ssKpq5.');
...
(1, 1234, 'alor', 'alor', 'alor', '2015-06-19', 'alor', '$2a$10$RWSeopvH6ofQJUDNZwBfJO1Z8eD.gEXzIE3drUYMS4EQ1.ssKpq5.');
