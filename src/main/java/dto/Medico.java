...
public class Medico implements Serializable {
    ...
    public Medico(Integer codiMedi, int ndniMedi, String appaMedi, String apmaMedi, String nombMedi, Date fechNaciMedi, String logiMedi, String passMedi) {
        this.codiMedi = codiMedi;
    ...
    public int getNdniMedi() {
        return ndniMedi;
    }

    public void setNdniMedi(int ndniMedi) {
        this.ndniMedi = ndniMedi;
    }
